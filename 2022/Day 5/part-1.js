...
[B] [L] [Q] [W] [S] [L] [J] [W] [Z]
 1   2   3   4   5   6   7   8   9 
  ...
  This results in containers being offloaded one at a time, FILO, and re-stacked so that the containers 
...
Example - 
  "move 3 from 5 to 2"
  Means take 3 containers from stack 5 and move them to stack 2.
...
function operateCrane(qty, from, to){
  if (qty > 0){
  let crane = containerShip[from-1].pop()
  containerShip[to-1].push(crane)
  qty -= 1;
